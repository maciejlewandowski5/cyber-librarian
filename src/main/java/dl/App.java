...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        double rec = Metrics.calculateRecall(expected, actual, countries);
        double prec = Metrics.calculatePrecision(expected, actual, countries);
        double f1 = Metrics.calculateF1(expected, actual, countries);
